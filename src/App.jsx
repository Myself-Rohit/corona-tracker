          ...
          <div className="sm:w-2/3 sm:mr-10">
            <div className="flex items-start justify-between">
              ...
              <div className="flex items-center">
                ...
                <div>
                  <FormControl>
                    <Select variant="outlined" onChange={onCountryChange} value={country} className="bg-gray-200 ">
                      <MenuItem value="worldwide">worldwide</MenuItem>
                      {countries.map((country) => <MenuItem key={country.name} value={country.value}>{country.name}
                      </MenuItem>)}
                    </Select>
                  </FormControl>
                </div>
